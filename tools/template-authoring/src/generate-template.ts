      ...
      properties: {
        ...
        implementations: {
          ...
          items: {
            ...
            properties: {
              ...
              purpose: { type: "string", enum: ["teaching", "concise", "iterative", "recursive", "optimized"] }, strategy: { type: "string" },
              ...
              normalization: {
                ...
                properties: {
                  ...
                  whitespace: { type: "string", const: "strict" },
                },
              },
            },
          },
        ...
        relationships: {
          ...
          items: {
            ...
            properties: {
              ...
              type: { type: "string", enum: ["depends_on", "influences", "analogous_to", "contrasts_with", "composes_with", "generalizes", "specializes", "supersedes"] },
        ...
        practice: {
          ...
          properties: {
            ...
            code_recall: { type: "array", items: { type: "object", additionalProperties: false, required: ["id", "implementation", "layout", "assistance", "prompt", "scaffold", "source_template", "slots"], properties: { id: { type: "string" }, implementation: { type: "string" }, layout: { type: "string", enum: ["full_recall", "comment_guided", "comment_to_code", "cloze"] }, assistance: { type: "string", enum: ["skeleton", "comments", "keywords", "cloze", "none"] }, prompt: { type: "string" }, scaffold: { type: "array", items: { type: "string" } }, source_template: { type: "string" }, slots: { type: "array", items: { type: "object", additionalProperties: false, required: ["id", "cue", "expected"], properties: { id: { type: "string" }, cue: { type: "string" }, expected: { type: "string" } } } } } } },
            reasoning_recall: { type: "array", items: { type: "object", additionalProperties: false, required: ["id", "implementation", "aspect", "prompt", "concepts", "aliases"], properties: { id: { type: "string" }, implementation: { type: "string" }, aspect: { type: "string", enum: ["mechanism", "invariant", "trade_off", "boundary", "failure_condition"] }, prompt: { type: "string" }, concepts: { type: "array", items: { type: "string" } }, aliases: { type: "array", items: { type: "string" } } } } },
            transfer_practice: { type: "array", items: { type: "object", additionalProperties: false, required: ["id", "implementation", "pattern", "new_case", "prompt", "concepts", "transfers", "differences", "boundaries"], properties: { id: { type: "string" }, implementation: { type: "string" }, pattern: { type: "string" }, new_case: { type: "string" }, prompt: { type: "string" }, concepts: { type: "array", items: { type: "string" } }, transfers: { type: "array", items: { type: "string" } }, differences: { type: "array", items: { type: "string" } }, boundaries: { type: "array", items: { type: "string" } } } } },
          },
        },
        validation: { type: "object", additionalProperties: false, required: ["schema", "code", "content_review", "transfer_review", "last_validated_at"], properties: { schema: { type: "string", const: "pending" }, code: { type: "string", const: "pending" }, content_review: { type: "string", const: "pending" }, transfer_review: { type: "string", const: "pending" }, last_validated_at: { type: ["string", "null"] } } },
